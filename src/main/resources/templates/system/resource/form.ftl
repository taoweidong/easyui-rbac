<form class="app-form" id="resource-form">
    ...
    <div class="field">
        <select id="resource-form-parent" value="${parentId!''}" name="parent" url="/system/resource/parent/tree"
                label="父资源：" style="width:100%"></select>
    </div>
    <div class="field">
    ...
    <div class="field">
        <select class="easyui-combobox" name="resType" panelHeight="auto" editable="false" label="资源类型："
                style="width:100%">
    ...
    <div class="field">
        <input class="easyui-textbox" name="funUrls" style="width:100%;height:60px"
               data-options="label:'功能URLS：',multiline:true">
    </div>
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="easyui-switchbutton" name="status" data-options="onText:'启用',offText:'禁用',checked:true"
               value="true">
    </div>
</form>
