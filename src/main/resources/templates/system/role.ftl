<div class="easyui-layout" fit="true">
    ...
    <div id="role-resource-panel" style="width:200px;border-bottom: none;"
         data-options="headerCls:'noborder',region:'east',collapsible:false,tools:'#role-resource-tools'" title="请选择角色">
        <!-- 资源树 -->
