...
<div data-options="region:'north'" style="height:60px;overflow: hidden;padding: 10px;background:#B3DFDA;">
...
<div id="footer" data-options="region:'south'"
     style="height:35px;text-align: center;line-height: 35px;overflow: hidden;background:#A9FACD;">
    <div id="online" class="online">
        当前在线人数：<span v-text="online"></span>
    </div>
    Copyright © 2019 AJR管理系统 v1.0 Powered by <a href="http://www.taoweidong.com/">Taowd</a>
    ...
    <div id="online_list" class="online-list">
        ...
        <div class="online-list-users">
            <ul>
                <li v-for="(user,i) in onlineUser" :id="'user'+user.uid" :key="user" :index="i"
                    @click="sendMsg(user,${s_member.id})">
